...
const mapNodes = [
  { id: 0, label: "Home", link: "/candyland/morningroutine", type:"gumdrop", relX:0.1, relY:0.8 },
  { id: 1, label: "Road to work", link: "/candyland/workmaze", type:"gumdrop", relX:0.28, relY:0.64 },
  { id: 2, label: "Whack-a-candy", link: "/candyland/whack-a-candy", type:"lollipop", relX:0.45, relY:0.52 },
  { id: 3, label: "Hot Chocolate tub", link: "/candyland/hotchocolate", type:"marshmallow", relX:0.62, relY:0.36 },
  { id: 4, label: "Caramel Apple", link: "/candyland/ending", type:"castle", relX:0.78, relY:0.24 }
];
